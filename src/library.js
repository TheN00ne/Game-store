...
export function Library(props){
    ...
    let [searchArr, setSearchArr] = useState(props.myAccount.libraryGames);

    function search(){
        let newGamesArr = props.myAccount.libraryGames.filter((el) => {
        ...
        let newAuthorsArr = props.myAccount.libraryGames.filter((el) => {
            let isOk = false;
            el.authors.map((auth) => {
